...
HISTORY_ENTRY_CLASS = "speed.aggregator.HistoryEntry"
...
@Requires("_sensors", "java:/speed.sensors.SpeedService",
          aggregate=True, optional=True)
@Provides("java:/speed.aggregator.AggregatorService")
class Aggregator(object):
    ...
    def _poll(self):
        ...
        while not self._thread_stop.is_set():
			...
			direction = sensor.getDirection()
                        self._store(name, value, unit, direction)
    ...
    def _store(self, sensor, value, unit, direction):
        """
